...
import TelegamLogo from "../../assets/img/telegram.svg"
import SupportPhone from "../../assets/img/support_img.png"
    ...
    <section className="support">
      <div ref={supportRef} className={"support__wrapper wrapper"}>
        <div
          ...
          ref={supportRef}
        >
          <img src={SupportPhone} alt="" className="support__phone" />
          <img src={SupportPhone} alt="" className="support__phone-mobile" />
